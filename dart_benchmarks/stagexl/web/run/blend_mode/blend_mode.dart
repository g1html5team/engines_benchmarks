...
import 'package:stagexl_benchmark/benchmarks/custom/blend_mode/engines/common.dart';
import 'package:stagexl_benchmark/benchmarks/custom/blend_mode/engines/stagexl.dart';
/// IDS
List<int> ids = [
  1,
...
return new StagexlBenchmarkBlendMode(

...
import 'package:stagexl_benchmark/benchmarks/custom/shader/engines/common.dart';
import 'package:stagexl_benchmark/benchmarks/custom/shader/engines/stagexl.dart';
...
GraphicEngineBenchmark _getEngine(
  ...
  int canvasHeight = int.parse(parameters['ch']);
    ...
    return new StagexlBenchmarkShader(

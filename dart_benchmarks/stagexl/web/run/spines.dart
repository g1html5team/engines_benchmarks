...
import 'package:stagexl_benchmark/benchmarks/custom/spines/engines/common.dart';
import 'package:stagexl_benchmark/benchmarks/custom/spines/engines/stagexl.dart';
...
GraphicEngineBenchmark _getEngine(
  ...
  return new StagexlBenchmarkSpines(
